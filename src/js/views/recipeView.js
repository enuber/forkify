...
//this works in parcel 2 with putting the url: first. in parcel 1 you don't put that in front. You can console log it to see that it just points to the created dist file
